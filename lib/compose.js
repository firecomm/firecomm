const generateUnaryCall = require("./calls/generateUnaryCall");
const generateClientStreamCall = require("./calls/generateClientStreamCall");
const ServerStreamCall = require("./calls/serverStreamCall");
const generateDuplex = require("./calls/generateDuplex");
